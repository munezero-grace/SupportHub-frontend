...
export const FilterPopup: React.FC<FilterModalProps> = ({
  ...
  const isStatusOrSupportTierSelected =
    (values.status && values.status !== '') ||
    (values.supportTier && values.supportTier !== '')
  ...
  return (
    <div
      ref={modalRef}
      className="absolute top-80 right-10 bg-white rounded-lg shadow-lg p-5 border border-gray-200 z-50 w-full sm:w-[250px] transition-all duration-200"
    >
